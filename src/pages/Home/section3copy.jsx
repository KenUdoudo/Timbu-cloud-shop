...
const Sec3home = () => {
    ...
    const fetchProducts = (page) => {
        fetch(`https://timbu-get-all-products.reavdev.workers.dev?organization_id=8ae37985db5c4bd88cfbd53f52972263&reverse_sort=false&page=${page}&size=10&Appid=YO1NW8GUL4ENHX6&Apikey=ee17b5f35b76441a9736019dc474f62a20240712195531195532`)
            .then(res => res.json())
            .then(data => {
                ...
                {products.map(product => (
                    <div key={product.id} className="w-full md:w-[30%] lg:w-[20%]">
                        ...
                        <div className="flex justify-between items-center">
                            <p className="font-semibold">₦{product.current_price.NGN}</p> {/* Access the NGN key from the current_price object */}
