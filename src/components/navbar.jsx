    ...
    return (
        <div className="px-[20px] md:px-[40px] py-[20px]  w-full font-pop">
            <div className='flex flex-row justify-between items-center'>
             ...
             <div className={`fixed top-0 right-0 h-full bg-[#e9e9e9] w-[75%] md:w-[50%] transform ${isOpen ? '-translate-x-0' : 'translate-x-full'} transition-transform duration-500 ease-in-out overflow-hidden`}>
            ...
            <button onClick={toggleMenu} className='block lg:hidden z-30'><HiOutlineMenu className="h-[25px] w-[25px]"/></button>
